...
urlpatterns = [
    ...
    path(
        "customer/delete/<slug:slug>", CustomerDelete.as_view(), name="customer-delete"
    ),
    ...
    path(
        "activity/delete/<slug:slug>", ActivityDelete.as_view(), name="activity-delete"
    ),
