# Generated by Django 4.1.3 on 2023-02-05 18:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_last_updated', models.DateTimeField(auto_now=True)),
                ('entry_created', models.DateTimeField(auto_now_add=True)),
                ('customer_transfer', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.PROTECT, to='gobasic.customer')),
            ],
            options={
