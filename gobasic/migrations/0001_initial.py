# Generated by Django 4.1.3 on 2023-01-11 23:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel_pb', models.ForeignKey(blank=True, limit_choices_to={'location_id': 1}, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='pb_hotel_set', to='gobasic.hotel', verbose_name='Hotel Port Blair')),
            ],
            options={
                'ordering': [],
            },
