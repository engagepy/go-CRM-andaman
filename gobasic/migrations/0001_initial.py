# Generated by Django 4.1.3 on 2023-01-08 18:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_categories', models.CharField(choices=[('1', 'Budget'), ('2', 'Premium'), ('3', 'Deluxe'), ('4', 'Luxury'), ('5', 'Ultra Luxury')], default='1', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel_hv', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='hv_hotel_set', to='gobasic.hotel', verbose_name='Hotel HV')),
                ('hotel_nl', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='nl_hotel_set', to='gobasic.hotel', verbose_name='Hotel NL')),
                ('hotel_pb', models.ForeignKey(blank=True, limit_choices_to={'hotel.rlocation': 'Port Blair'}, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='pb_hotel_set', to='gobasic.hotel', verbose_name='Hotel PB')),
            ],
            options={
                'ordering': [],
            },
